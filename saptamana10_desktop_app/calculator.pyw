...
buton_stergere = Button(frame_butoane, text='C', width=37, height=3, bg='lightyellow', cursor='hand2',
...
egal = Button(frame_butoane, text='=', width=10, height=3, bg='#FFA500', cursor='hand2',
